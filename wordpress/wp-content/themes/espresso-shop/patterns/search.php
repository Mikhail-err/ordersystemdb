 ...
 * Search Section
 * 
 * slug: espresso-shop/search-page
 * title: Search Page
 * categories: espresso-shop
 */

return array(
    'title'      =>__( 'Search Page', 'espresso-shop' ),
...
<!-- wp:column {"width":"30%"} -->
<div class="wp-block-column" style="flex-basis:30%"><!-- wp:template-part {"slug":"sidebar","theme":"espresso-shop","tagName":"div"} /--></div>
<!-- /wp:column --></div>
<!-- /wp:columns --></div>
<!-- /wp:group -->',
);
